...
const VARIANTS := [
	...
	},
	{
		...
		"label_height":0.38,
		"label_y":0.02,
		"cup_color":Color(0.38,0.13,0.028),
		"cup_shell":"amber_glass",
		"cup_dimensions":{"top_radius":0.40,"bottom_radius":0.36,"height":1.42},
		"container_profile":{"kind":"amber_bottle","body_color":Color(0.44,0.15,0.032),"glass_alpha":0.48,"neck_radius":0.18,"roughness":0.055},
	...
	},
	{
		...
		"label_height":0.42,
		"label_y":-0.02,
		"cup_color":Color(0.82,0.94,0.93),
		"cup_shell":"clear_glass",
		"cup_dimensions":{"top_radius":0.39,"bottom_radius":0.35,"height":1.46},
		"container_profile":{"kind":"clear_bottle","body_color":Color(0.92,0.98,0.97),"glass_alpha":0.19,"neck_radius":0.175,"liquid_color":Color(0.92,0.93,0.68),"roughness":0.045},
