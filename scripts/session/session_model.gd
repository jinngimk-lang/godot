...
const VARIANTS := [
	...
	},
	{
		...
		"container_profile":{"kind":"amber_bottle","body_color":Color(0.72,0.245,0.045),"glass_alpha":0.24,"neck_radius":0.175,"roughness":0.040},
		"scene_profile":{"id":"night_bar","table_color":Color(0.052,0.027,0.015),"table_roughness":0.25,"ambient_color":Color(0.075,0.040,0.024),"accent_color":Color(1.0,0.38,0.075),"light_energy":1.24},
	...
	},
	{
		...
		"container_profile":{"kind":"clear_bottle","body_color":Color(0.96,0.995,0.99),"glass_alpha":0.12,"neck_radius":0.17,"liquid_color":Color(0.93,0.90,0.66),"roughness":0.030},
