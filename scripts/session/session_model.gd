...
const VARIANTS := [
	{
		...
		"container_profile":{"kind":"paper_cup","body_color":Color(0.89,0.84,0.74),"lid_color":Color(0.035,0.032,0.030),"roughness":0.88},
		"scene_profile":{"id":"cafe_window","table_color":Color(0.22,0.115,0.055),"table_roughness":0.54,"ambient_color":Color(0.20,0.15,0.11),"accent_color":Color(1.0,0.70,0.38),"light_energy":1.18},
	...
	},
	{
		...
		"container_profile":{"kind":"amber_bottle","body_color":Color(0.20,0.065,0.018),"glass_alpha":0.72,"neck_radius":0.21,"roughness":0.16},
		"scene_profile":{"id":"night_bar","table_color":Color(0.07,0.035,0.018),"table_roughness":0.38,"ambient_color":Color(0.055,0.028,0.018),"accent_color":Color(1.0,0.34,0.055),"light_energy":1.34},
	...
	},
	{
		...
		"container_profile":{"kind":"clear_bottle","body_color":Color(0.86,0.95,0.94),"glass_alpha":0.34,"neck_radius":0.20,"liquid_color":Color(0.91,0.91,0.66),"roughness":0.10},
		"scene_profile":{"id":"market_coldcase","table_color":Color(0.73,0.74,0.71),"table_roughness":0.46,"ambient_color":Color(0.60,0.67,0.72),"accent_color":Color(0.70,0.90,1.0),"light_energy":1.02},
		"post_peel_action":"inspect",
		"crumple_profile":{"rigidity":0.055,"dent_gain":0.0035,"max_compression":0.18},
		"contents_profile":{"type":"none"},
		"reward_theme":"crisp",
		"hint":"cool glass • inspect residue from every angle"
	}
]
