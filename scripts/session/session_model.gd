...
const VARIANTS := [
	{
		...
		"scene_profile":{"id":"cafe_window","table_color":Color(0.20,0.095,0.040),"table_roughness":0.48,"ambient_color":Color(0.20,0.15,0.11),"accent_color":Color(1.0,0.70,0.38),"light_energy":1.18,"camera_fov":39.0},
	...
	},
	{
		...
		"scene_profile":{"id":"night_bar","table_color":Color(0.052,0.027,0.015),"table_roughness":0.25,"ambient_color":Color(0.055,0.028,0.018),"accent_color":Color(1.0,0.34,0.055),"light_energy":1.18,"camera_fov":48.0},
	...
	},
	{
		...
		"scene_profile":{"id":"market_coldcase","table_color":Color(0.76,0.77,0.75),"table_roughness":0.38,"ambient_color":Color(0.60,0.67,0.72),"accent_color":Color(0.70,0.90,1.0),"light_energy":1.02,"camera_fov":48.0},
		"post_peel_action":"inspect",
