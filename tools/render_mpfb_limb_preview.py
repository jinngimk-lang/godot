...
_render_view(armature, camera, "right_hand_front", hand_center + Vector((0.02, -0.38, 0.07)), hand_center)
_render_view(armature, camera, "right_hand_oblique", hand_center + Vector((-0.28, -0.25, 0.16)), hand_center)
_render_view(armature, camera, "right_forearm_oblique", forearm_center + Vector((-0.34, -0.48, 0.20)), forearm_center)
